...
//					let ident = this.nats.subscribe(subject, (data, reply, subject, sid) => {
				...
				socket.on('request', (msg) => {
					...
					console.log('got request:', subject, '->', msg);
					...
					console.log('allowing request:', subject, '->', data);
					...
					this.nats.request(subject, (error, msg) => {
						...
						console.log("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
						console.log('got response:', subject, '->', error, msg.code,msg.data);
						...
						this.handleResponse(session.user, subject, msg.data, session);
	...
	initAccess(authMsg, publicFilter, privateFilter) {
	...
	handleResponse(user, subject, response, session) {
		if(subject == this.authMsg) {
